...
local large_setting = {
  ...
  cache_path ::  if misc_params.value_pred then "cache/exp_income_expand1_no" else "cache/exp_income_expand1_no", 
...
local devset_config = {
  cache_suffix :: "val", 
  data_suffix :: "dev_data_syn_income_expand1.json",
...
local trainset_config = {
  cache_suffix :: "train",
  data_suffix :: "train_data_syn_income_expand1.json",
  limit_instances :: -1,
...

{
  "dataset_reader": {
    ...
    "tables_file": dataset_path + "table_syn_income_expand1.json",
  ...
  "train_data_path": dataset_path + "train_data_syn_income_expand1.json",
  "validation_data_path": dataset_path + "dev_data_syn_income_expand1.json",
